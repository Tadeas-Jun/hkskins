...
const IndexPage = ({data}) => {
  ...
  return (
    <main>
      ...
      <p>The entire list (.zip file containing a directory for each skin, each including a metadata.json file and the preview.png file) can be downloaded <a href="/skins.zip">here</a>. Skins that don't include the player characters are currently not included in this archive, but are planned to be added later.</p>
