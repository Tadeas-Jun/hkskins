...
const IndexPage = ({data}) => {
  ...
  return (
    <main>
      ...
      <p>The website was last updated on <strong>2026-07-03</strong> (<em>v1.3.2</em>). To browse the most recent changes, see the <Link to="/changelog">Changelog page</Link>.</p>
